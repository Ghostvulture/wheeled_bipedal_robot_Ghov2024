...
#include "main.h"
#include "../LKMotor/LK9025.hpp"
#include "../LKMotor/LKMotor.hpp"
#include "Pid.hpp"
...
public:
     ...
     * @note 构造时自动初始化计算值为0
     */
    Odometer(LK9025 *LMotor, LK9025 *RMotor) : LMotor(LMotor), RMotor(RMotor)
    {
        odometry.x = 0;
        odometry.y = 0;
        odometry.theta = 0;
...
void speedNposition_estimation()
{

    
}

static LinkNPodParam linkNPodParam;
static ChassisParam chassisParam;

/*
 * @brief 把电机和imu反馈数据整合到结构体中
*/
